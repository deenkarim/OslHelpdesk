<%@ Page Language="vb" AutoEventWireup="false" Inherits="OslHelpdesk.clticket" CodeFile="clticket.aspx.vb" %>
<!-- #include file="layout/headerclosedticket.html" -->
<form id="Form2" method="post" runat="server">
	<font size="5" color="#000000"><b>Closed Tickets</b></font><BR>
	<BR>
	<asp:DataGrid id="dgClosed" runat="server" BorderColor="#DEDFDE" BackColor="White" Height="0px"
		Width="800px" BorderStyle="None" BorderWidth="1px"
		CellPadding="4" GridLines="Vertical" AutoGenerateColumns="False" ForeColor="Black">
