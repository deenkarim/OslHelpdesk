...
#Region " Web Form Designer Generated Code "
    ...
    End Sub
    Protected WithEvents dgResolved As System.Web.UI.WebControls.DataGrid
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim retickets As New DataSet

        optickets = ticket.GetOpenTicketsAdmin
        retickets = ticket.GetResolvedTicketsAdmin

        dgOpen.DataSource = optickets.Tables("OpenTickets")
        dgResolveda.DataSource = retickets.Tables("Resolved")

        dgOpen.DataBind()
        dgResolveda.DataBind()
    End Sub
