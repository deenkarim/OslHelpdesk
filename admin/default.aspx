<%@ Page Language="vb" AutoEventWireup="false" Inherits="OslHelpdesk._default1" CodeFile="default.aspx.vb" %>
<!-- #include file="layout/headerhome.html" -->
<form id="Form1" method="post" runat="server">
	<font size="5" color="#000000"><b>Administration</b></font><BR>
	<BR>
	<asp:DataGrid id="dgOpen" runat="server" BorderColor="#DEDFDE" BackColor="White" Height="0px"
