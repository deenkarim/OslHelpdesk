<%@ Page Language="vb" AutoEventWireup="false" Inherits="OslHelpdesk.vticket1" CodeFile="vticket.aspx.vb" %>
...
<form id="Form1" method="post" runat="server">
	<table border="0" cellpadding="4" cellspacing="4" height="532">
		...
		<tr>
			...
			<td>
				<asp:Button ID="btnAssign" runat="server" Text="Assign Ticket" CssClass="button" />&nbsp;
